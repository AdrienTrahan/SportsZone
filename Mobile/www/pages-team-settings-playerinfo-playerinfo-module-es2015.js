...
/* harmony import */ var _playerinfo_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./playerinfo.page */ "./src/app/pages/team/settings/playerinfo/playerinfo.page.ts");
...
/* harmony import */ var _playerinfo_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./playerinfo-routing.module */ "./src/app/pages/team/settings/playerinfo/playerinfo-routing.module.ts");
/* harmony import */ var _playerinfo_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./playerinfo.page */ "./src/app/pages/team/settings/playerinfo/playerinfo.page.ts");
...
PlayerinfoPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _playerinfo_routing_module__WEBPACK_IMPORTED_MODULE_5__["PlayerinfoPageRoutingModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlayerinfoPage", function() { return PlayerinfoPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var src_app_pages_home_home_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/pages/home/home.page */ "./src/app/pages/home/home.page.ts");
/* harmony import */ var _controller_team_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../controller/team.page */ "./src/app/pages/team/controller/team.page.ts");
...
/* harmony import */ var text_mask_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! text-mask-core */ "./node_modules/text-mask-core/dist/textMaskCore.js");
/* harmony import */ var text_mask_core__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(text_mask_core__WEBPACK_IMPORTED_MODULE_12__);
...
let PlayerinfoPage = class PlayerinfoPage {
    constructor(translate, actionSheetController, sanitizer, crop, http, transfer) {
    ...
    ngOnInit() {
        this.load();
        let player = src_app_pages_home_home_page__WEBPACK_IMPORTED_MODULE_5__["HomePage"].players.find(player => { return player.id == this.alias.teamInfo.playerId; });
    ...
    mask(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const maskedInput = Object(text_mask_core__WEBPACK_IMPORTED_MODULE_12__["createTextMaskInputElement"])({
                inputElement: this.inputElement,
                mask: this.phoneMask,
                guide: false,
            });
            yield maskedInput.update(event.target.value.replace(/\D/g, '') + "");
    ...
    save() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let obj = { token: token, id: _controller_team_page__WEBPACK_IMPORTED_MODULE_6__["TeamPage"].teamInfo.id, playerId: this.alias.teamInfo.playerId, last: this.lastname, first: this.firstname, contacts: JSON.stringify(this.contacts), sex: this.sex, age: this.age, position: this.position, shirtnumber: this.shirtnumber };
            let result;
            if (this.unmodified.image != (this.imageUrl || this.image)) {
                ...
                result = yield Object(src_app_functions_call__WEBPACK_IMPORTED_MODULE_3__["upload"])('http://192.168.2.251:3000/api/savePlayerInfo', this.imageUrl, obj, this.http, this.transfer);
            }
            else {
                this.unmodified = {
                    firstname: this.firstname,
                ...
                result = yield Object(src_app_functions_call__WEBPACK_IMPORTED_MODULE_3__["post"])('http://192.168.2.251:3000/api/savePlayerInfo', obj);
            }
        });
    }
    addContact() {
    ...
    load() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let token = yield Object(src_app_functions_storage__WEBPACK_IMPORTED_MODULE_4__["get"])("token");
            let result = yield Object(src_app_functions_call__WEBPACK_IMPORTED_MODULE_3__["call"])("http://192.168.2.251:3000/api/getPlayerPublicInfo", {
                token: token,
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('phoneInput')
], PlayerinfoPage.prototype, "phoneInput", null);
PlayerinfoPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-playerinfo',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./playerinfo.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/team/settings/playerinfo/playerinfo.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./playerinfo.page.scss */ "./src/app/pages/team/settings/playerinfo/playerinfo.page.scss")).default]
    })
], PlayerinfoPage);
...
//# sourceMappingURL=pages-team-settings-playerinfo-playerinfo-module-es2015.js.map