...
export class EventPage implements OnInit {
  ...
  constructor(public translate: TranslateService, private router: Router, private route: ActivatedRoute, public alertController: AlertController, public platform: Platform) {
